...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x02, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0x12, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0x22, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0x32, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0x42, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0x52, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0x62, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0x72, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0x92, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0xb2, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0xd2, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        OpCode::new(0xf2, Mnemonic::NOP, "*NOP", 1,2, AddressingMode::NoneAddressing),
        ...
        OpCode::new(0xab, Mnemonic::LXA, "*LXA", 2, 3, AddressingMode::Immediate), //todo: highly unstable and not used
